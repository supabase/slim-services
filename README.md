...
| Realtime | `v2.129.13` | `116.9 MiB` | `27.3 MiB` | `76.7%` | `178.3 MiB` | `0.22%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.13) · [report](services/realtime/REPORT.md) |
...
| Realtime | `v2.129.13` | `12.0 MiB` | `48.4 MiB` | `211.6 MiB` | `0.30%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.13) · [report](services/realtime/REPORT.md) |
