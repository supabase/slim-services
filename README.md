...
| Storage | `v1.69.8` | `223.8 MiB` | `51.0 MiB` | `77.2%` | `214.8 MiB` | `0.01%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.69.8) · [report](services/storage/REPORT.md) |
...
| Storage | `v1.69.8` | `36.1 MiB` | `143.6 MiB` | `287.4 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.69.8) · [report](services/storage/REPORT.md) |
