...
| Realtime | `v2.129.7` | `116.9 MiB` | `27.2 MiB` | `76.7%` | `179.9 MiB` | `0.24%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.7) · [report](services/realtime/REPORT.md) |
...
| Realtime | `v2.129.7` | `12.0 MiB` | `48.3 MiB` | `212.5 MiB` | `0.07%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.7) · [report](services/realtime/REPORT.md) |
