...
| Realtime | `v2.129.12` | `116.9 MiB` | `27.3 MiB` | `76.7%` | `178.9 MiB` | `0.21%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.12) · [report](services/realtime/REPORT.md) |
...
| Realtime | `v2.129.12` | `12.0 MiB` | `48.4 MiB` | `212.2 MiB` | `0.13%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.12) · [report](services/realtime/REPORT.md) |
