...
total **2044.1 MiB** compressed; the slim set totals **561.6 MiB** (**72.5%**
...
| Realtime | `v2.129.8` | `116.9 MiB` | `27.2 MiB` | `76.7%` | `179.9 MiB` | `0.21%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.8) · [report](services/realtime/REPORT.md) |
...
| Realtime | `v2.129.8` | `12.0 MiB` | `48.3 MiB` | `213.0 MiB` | `0.20%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.8) · [report](services/realtime/REPORT.md) |
