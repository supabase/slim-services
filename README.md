...
| Realtime | `v2.127.0` | `116.6 MiB` | `27.0 MiB` | `76.8%` | `176.6 MiB` | `0.15%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.127.0) · [report](services/realtime/REPORT.md) |
...
| Realtime | `v2.127.0` | `11.7 MiB` | `47.8 MiB` | `212.7 MiB` | `0.37%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.127.0) · [report](services/realtime/REPORT.md) |
