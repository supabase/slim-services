...
total **2047.9 MiB** compressed; the slim set totals **535.4 MiB** (**73.9%**
...
| Realtime | `v2.137.3` | `116.8 MiB` | `24.0 MiB` | `79.5%` | `177.3 MiB` | `0.18%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.137.3) · [report](services/realtime/REPORT.md) |
| Storage | `v1.79.4` | `221.7 MiB` | `49.2 MiB` | `77.8%` | `214.4 MiB` | `3.88%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.79.4) · [report](services/storage/REPORT.md) |
...
| Realtime | `v2.137.3` | `11.9 MiB` | `48.6 MiB` | `212.6 MiB` | `0.10%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.137.3) · [report](services/realtime/REPORT.md) |
| Storage | `v1.79.4` | `36.2 MiB` | `149.6 MiB` | `285.9 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.79.4) · [report](services/storage/REPORT.md) |
