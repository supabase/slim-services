...
total **2042.9 MiB** compressed; the slim set totals **562.3 MiB** (**72.5%**
...
| Realtime | `v2.126.0` | `116.6 MiB` | `27.0 MiB` | `76.8%` | `176.1 MiB` | `0.19%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.126.0) · [report](services/realtime/REPORT.md) |
| Storage | `v1.69.2` | `223.8 MiB` | `51.0 MiB` | `77.2%` | `219.0 MiB` | `0.03%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.69.2) · [report](services/storage/REPORT.md) |
...
| Realtime | `v2.126.0` | `11.7 MiB` | `47.8 MiB` | `209.9 MiB` | `0.60%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.126.0) · [report](services/realtime/REPORT.md) |
| Storage | `v1.69.2` | `36.1 MiB` | `143.6 MiB` | `291.5 MiB` | `0.03%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.69.2) · [report](services/storage/REPORT.md) |
