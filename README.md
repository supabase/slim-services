...
| Realtime | `v2.129.11` | `116.9 MiB` | `27.2 MiB` | `76.7%` | `180.3 MiB` | `0.21%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.11) · [report](services/realtime/REPORT.md) |
...
| Realtime | `v2.129.11` | `12.0 MiB` | `48.3 MiB` | `211.8 MiB` | `0.17%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.11) · [report](services/realtime/REPORT.md) |
