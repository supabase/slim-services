...
total **2047.8 MiB** compressed; the slim set totals **536.4 MiB** (**73.8%**
...
|---|---:|---:|---:|---:|---:|---:|---|
| Postgres | `17.6.1.171` (all PostgreSQL extensions for the selected major, matching upstream preload configuration) | `349.9 MiB` | `103.7 MiB` | `70.4%` | `79.9 MiB` | `0.00%` | [release](https://github.com/supabase/slim-services/releases/tag/postgres-17.6.1.171) · [report](services/postgres/REPORT.md) |
...
| Realtime | `v2.135.0` | `116.9 MiB` | `24.0 MiB` | `79.5%` | `178.3 MiB` | `0.12%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.135.0) · [report](services/realtime/REPORT.md) |
| Storage | `v1.77.0` | `220.7 MiB` | `49.2 MiB` | `77.7%` | `214.7 MiB` | `3.81%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.77.0) · [report](services/storage/REPORT.md) |
...
| Studio | `2026.09.07-sha-7996410` | `306.5 MiB` | `137.4 MiB` | `55.2%` | `214.6 MiB` | `2.28%` | [release](https://github.com/supabase/slim-services/releases/tag/studio-2026.09.07-sha-7996410) · [report](services/studio/REPORT.md) |
| Analytics | `v1.50.11` | `261.1 MiB` | `55.3 MiB` | `78.8%` | `504.2 MiB` | `0.29%` | [release](https://github.com/supabase/slim-services/releases/tag/analytics-v1.50.11) · [report](services/analytics/REPORT.md) |
| PgMeta | `v0.99.0` | `108.7 MiB` | `58.8 MiB` | `45.9%` | `118.8 MiB` | `3.93%` | [release](https://github.com/supabase/slim-services/releases/tag/pgmeta-v0.99.0) · [report](services/pgmeta/REPORT.md) |
...
|---|---:|---:|---:|---:|---:|---|---|
| Postgres | `17.6.1.171` | `97.0 MiB` | `441.8 MiB` | `67.0 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/postgres-17.6.1.171) · [report](services/postgres/REPORT.md) |
...
| Realtime | `v2.135.0` | `11.9 MiB` | `48.6 MiB` | `209.7 MiB` | `0.17%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.135.0) · [report](services/realtime/REPORT.md) |
| Storage | `v1.77.0` | `36.2 MiB` | `149.6 MiB` | `284.4 MiB` | `0.03%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.77.0) · [report](services/storage/REPORT.md) |
...
| Studio | `2026.09.07-sha-7996410` | `76.9 MiB` | `475.2 MiB` | `322.1 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/studio-2026.09.07-sha-7996410) · [report](services/studio/REPORT.md) |
| Analytics | `v1.50.11` | `33.3 MiB` | `140.5 MiB` | `530.9 MiB` | `0.37%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/analytics-v1.50.11) · [report](services/analytics/REPORT.md) |
| PgMeta | `v0.99.0` | `40.4 MiB` | `186.0 MiB` | `163.6 MiB` | `0.27%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/pgmeta-v0.99.0) · [report](services/pgmeta/REPORT.md) |
