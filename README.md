...
total **2044.1 MiB** compressed; the slim set totals **563.1 MiB** (**72.5%**
...
|---|---:|---:|---:|---:|---:|---:|---|
| Postgres | `17.6.1.165` (all PG17 extensions, minimal preload) | `349.8 MiB` | `132.7 MiB` | `62.1%` | `47.9 MiB` | `0.01%` | [release](https://github.com/supabase/slim-services/releases/tag/postgres-17.6.1.165) · [report](services/postgres/REPORT.md) |
