...
| Storage | `v1.68.14` | `223.4 MiB` | `51.0 MiB` | `77.2%` | `218.8 MiB` | `0.03%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.14) · [report](services/storage/REPORT.md) |
...
| Storage | `v1.68.14` | `36.1 MiB` | `143.6 MiB` | `293.9 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.14) · [report](services/storage/REPORT.md) |
