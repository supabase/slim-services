...
total **2041.9 MiB** compressed; the slim set totals **561.7 MiB** (**72.5%**
...
| Realtime | `v2.124.3` | `116.5 MiB` | `27.0 MiB` | `76.8%` | `178.0 MiB` | `0.22%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.124.3) · [report](services/realtime/REPORT.md) |
| Storage | `v1.68.15` | `223.4 MiB` | `51.0 MiB` | `77.2%` | `218.2 MiB` | `0.03%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.15) · [report](services/storage/REPORT.md) |
...
| PgMeta | `v0.96.8` | `102.5 MiB` | `55.5 MiB` | `45.9%` | `101.1 MiB` | `0.23%` | [release](https://github.com/supabase/slim-services/releases/tag/pgmeta-v0.96.8) · [report](services/pgmeta/REPORT.md) |
...
| Realtime | `v2.124.3` | `11.7 MiB` | `47.7 MiB` | `214.9 MiB` | `0.33%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.124.3) · [report](services/realtime/REPORT.md) |
| Storage | `v1.68.15` | `36.1 MiB` | `143.6 MiB` | `245.5 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.15) · [report](services/storage/REPORT.md) |
...
| PgMeta | `v0.96.8` | `37.2 MiB` | `173.7 MiB` | `164.8 MiB` | `0.30%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/pgmeta-v0.96.8) · [report](services/pgmeta/REPORT.md) |
