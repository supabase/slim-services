...
| Storage | `v1.68.12` | `223.3 MiB` | `51.0 MiB` | `77.2%` | `219.1 MiB` | `0.01%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.12) · [report](services/storage/REPORT.md) |
...
| Storage | `v1.68.12` | `36.1 MiB` | `143.6 MiB` | `293.0 MiB` | `0.03%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.12) · [report](services/storage/REPORT.md) |
