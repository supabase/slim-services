...
total **2041.8 MiB** compressed; the slim set totals **561.7 MiB** (**72.5%**
...
| Storage | `v1.68.11` | `223.3 MiB` | `51.0 MiB` | `77.2%` | `217.7 MiB` | `0.03%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.11) · [report](services/storage/REPORT.md) |
...
| Storage | `v1.68.11` | `36.1 MiB` | `143.6 MiB` | `291.1 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.68.11) · [report](services/storage/REPORT.md) |
