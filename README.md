...
| Realtime | `v2.125.2` | `116.6 MiB` | `27.0 MiB` | `76.8%` | `176.2 MiB` | `0.20%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.125.2) · [report](services/realtime/REPORT.md) |
| Storage | `v1.69.1` | `223.4 MiB` | `51.0 MiB` | `77.2%` | `219.5 MiB` | `0.02%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.69.1) · [report](services/storage/REPORT.md) |
...
| Realtime | `v2.125.2` | `11.7 MiB` | `47.8 MiB` | `209.6 MiB` | `0.30%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.125.2) · [report](services/realtime/REPORT.md) |
| Storage | `v1.69.1` | `36.1 MiB` | `143.6 MiB` | `293.1 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.69.1) · [report](services/storage/REPORT.md) |
