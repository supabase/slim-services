...
| Storage | `v1.70.7` | `223.8 MiB` | `51.0 MiB` | `77.2%` | `215.0 MiB` | `0.02%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.70.7) · [report](services/storage/REPORT.md) |
...
| Storage | `v1.70.7` | `36.1 MiB` | `143.6 MiB` | `288.9 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.70.7) · [report](services/storage/REPORT.md) |
