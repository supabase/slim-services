...
| Storage | `v1.70.6` | `223.8 MiB` | `51.0 MiB` | `77.2%` | `215.7 MiB` | `0.01%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.70.6) · [report](services/storage/REPORT.md) |
...
| Storage | `v1.70.6` | `36.1 MiB` | `143.6 MiB` | `290.3 MiB` | `0.03%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.70.6) · [report](services/storage/REPORT.md) |
