...
total **2049.4 MiB** compressed; the slim set totals **566.7 MiB** (**72.3%**
...
|---|---:|---:|---:|---:|---:|---:|---|
| Postgres | `17.6.1.165` (all PG17 extensions, minimal preload) | `349.9 MiB` | `132.7 MiB` | `62.1%` | `47.9 MiB` | `0.01%` | [release](https://github.com/supabase/slim-services/releases/tag/postgres-17.6.1.165) · [report](services/postgres/REPORT.md) |
...
| Realtime | `v2.129.6` | `122.2 MiB` | `32.3 MiB` | `73.6%` | `179.9 MiB` | `0.21%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.6) · [report](services/realtime/REPORT.md) |
| Storage | `v1.70.5` | `223.8 MiB` | `51.0 MiB` | `77.2%` | `216.1 MiB` | `0.01%` | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.70.5) · [report](services/storage/REPORT.md) |
...
| Analytics | `v1.50.5` | `261.4 MiB` | `58.5 MiB` | `77.6%` | `496.1 MiB` | `0.27%` | [release](https://github.com/supabase/slim-services/releases/tag/analytics-v1.50.5) · [report](services/analytics/REPORT.md) |
...
|---|---:|---:|---:|---:|---:|---|---|
| Postgres | `17.6.1.165` | `103.0 MiB` | `662.6 MiB` | `72.7 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/postgres-17.6.1.165) · [report](services/postgres/REPORT.md) |
...
| Realtime | `v2.129.6` | `15.8 MiB` | `62.2 MiB` | `217.1 MiB` | `0.43%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.129.6) · [report](services/realtime/REPORT.md) |
| Storage | `v1.70.5` | `36.1 MiB` | `143.6 MiB` | `289.0 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/storage-v1.70.5) · [report](services/storage/REPORT.md) |
...
| Analytics | `v1.50.5` | `33.4 MiB` | `140.6 MiB` | `500.2 MiB` | `0.13%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/analytics-v1.50.5) · [report](services/analytics/REPORT.md) |
