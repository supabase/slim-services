...
|---|---:|---:|---:|---:|---:|---:|---|
| Postgres | `17.6.1.164` (all PG17 extensions, minimal preload) | `349.8 MiB` | `132.7 MiB` | `62.1%` | `47.5 MiB` | `0.01%` | [release](https://github.com/supabase/slim-services/releases/tag/postgres-17.6.1.164) · [report](services/postgres/REPORT.md) |
...
|---|---:|---:|---:|---:|---:|---|---|
| Postgres | `17.6.1.164` | `103.0 MiB` | `662.6 MiB` | `72.5 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/postgres-17.6.1.164) · [report](services/postgres/REPORT.md) |
