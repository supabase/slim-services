...
total **2044.1 MiB** compressed; the slim set totals **562.5 MiB** (**72.5%**
...
| Pooler | `v2.9.11` | `289.4 MiB`* | `38.7 MiB` | `86.6%`* | `165.2 MiB` | `0.11%` | [release](https://github.com/supabase/slim-services/releases/tag/pooler-v2.9.11) · [report](services/pooler/REPORT.md) |
...
| Pooler | `v2.9.11` | `23.5 MiB` | `52.5 MiB` | `208.3 MiB` | `0.00%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/pooler-v2.9.11) · [report](services/pooler/REPORT.md) |
