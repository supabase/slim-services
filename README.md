...
| Realtime | `v2.125.3` | `116.6 MiB` | `27.0 MiB` | `76.8%` | `176.1 MiB` | `0.14%` | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.125.3) · [report](services/realtime/REPORT.md) |
...
| Realtime | `v2.125.3` | `11.7 MiB` | `47.8 MiB` | `208.8 MiB` | `0.80%` | yes | [release](https://github.com/supabase/slim-services/releases/tag/realtime-v2.125.3) · [report](services/realtime/REPORT.md) |
